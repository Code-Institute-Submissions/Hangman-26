...
def welcome():
    ...
    print('\n' * 4)
    while True:
        player_choice = input('Please select 1 to play the game\
             or 2 to see the rules.\n')
        if player_choice == '1':
            print('hello')
...
def rules():
    ...
    title()
    print('\n' * 2)
    print('{:^80}'.format("To play the game you must guess the\
                          letters of the hidden word."))
    print('{:^80}'.format("If the guess is correct the\
                          letter missing in the word"))
    print('{:^80}'.format("is replaced by the correct letter."))
    print('{:^80}'.format("You can enter the whole word if\
                           you now what the word is."))
    ...
    print('{:^80}'.format("M for medium (8 lives) or\
                           H for hard (6 lives)"))
    print('{:^80}'.format("Be careful because a harder level\
                          means more letters."))
